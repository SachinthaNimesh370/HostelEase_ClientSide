...
export default function DrawerSecurity() {
  ...
  // Only one page for security: Visitor Log
  const drawerItems = [
    { text: 'Visitor Log', icon: <AccountCircleRoundedIcon />, path: 'securityVisitorLog' },
  ];

  const handleNavigate = (path) => {
    navigate(`/drawersec/${path}`);
  };

  const isActive = (path) => location.pathname === `/drawersec/${path}`;
